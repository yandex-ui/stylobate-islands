...
Можно попробовать потрогать концепцию, склонировав себе рекурсивно соответствующий [проектик](https://github.com/yandex-ui/stylobate-islands-starter), после чего повставлять в `style.styl` разные примеры с этого сайта. В дальнейшем будет написано много разных туториалов на разные темы, если что-то конкретное хочется услышать прямо сейчас, можете завести соответствующие issues — это будет хорошим способом расставить приоритеты.
