...
Селект _относительно_ можно попробовать сделать с помощью CSS, но количество хаков для разных браузеров зашкаливает, пока непонятно нужно ли это в принципе делать, или обойтись js?

> <span class="button select-wrap">
>     <select class="select button-content">
